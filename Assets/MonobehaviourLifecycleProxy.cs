...
public class MonobehaviourLifecycleProxy : MonoBehaviour
{
    public MonobehaviourLifecycleEvents Callbacks;
    private void Awake()
    {
        if (Callbacks == null) Callbacks = new MonobehaviourLifecycleEvents();
